...
\addplot [color=mycolor3, line width=1.0pt, mark=triangle, mark options={solid, mycolor3}]
  table[row sep=crcr]{%
0	nan\\
0.5	nan\\
...
\addplot [color=mycolor4, line width=1.0pt, mark=diamond, mark options={solid, mycolor4}]
  table[row sep=crcr]{%
0	nan\\
0.5	nan\\
1	nan\\
